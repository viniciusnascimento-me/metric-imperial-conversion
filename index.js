...
cvtBtn.addEventListener("click", function calcConversion (numbConvert) {
    ...
    lengthImp = numbConvert * 3.281 // pega o valor do INPUT e transforma de Metrico -> Imperial
    lengthMet = numbConvert / 3.281 // pega o valor do INPUT e transforma de Imperial -> Metrico
    
    volumeImp = numbConvert * 0.264 // pega o valor do INPUT e transforma de Metrico -> Imperial
    volumeMet = numbConvert / 0.264 // pega o valor do INPUT e transforma de Imperial -> Metrico
    
    massImp = numbConvert * 2.204 // pega o valor do INPUT e transforma de Metrico -> Imperial
    massMet = numbConvert / 2.204 // pega o valor do INPUT e transforma de Imperial -> Metrico
